...
import { LoginPopupComponents } from '../Login/components/LoginPopupComponents';
...
export const SignUpPopup = {
    ...
    showSignUpPopup(
        ...
        const closeButton = LoginPopupComponents.createCloseButton(
            ...
            popupHeight,
            () => {
                SignUpPopup.hideSignUpPopup(scene, state, onCancel);
            }
        );
        popupContainer.add(closeButton);
        
        // 타이틀
        const titleText = LoginPopupComponents.createTitle(scene, popupHeight, '회원가입');
        ...
        const { loginButton, cancelButton } = LoginPopupComponents.createActionButtons(
            ...
            () => {
                ...
                SignUpPopup.hideSignUpPopup(scene, state, () => {});
        ...
        // 버튼 텍스트 변경 (회원가입)
        loginButton.list.forEach((child: any) => {
